...
* ADD Macro for the description of the hydrodynamic models for the manipulator models.
...
* Merge pull request `#21 <https://github.com/uuvsimulator/uuv_simulator/issues/21>`_ from uuvsimulator/dev/manipulation
  Dev/manipulation
* replace collision meshes with primitives
  modify joint parameters as suggested here:
...
* Adding new Oberon 4 arm (robot description and configuration parameters).
  Signed-off-by: Musa Morena Marcusso Manhães <Musa.Marcusso@de.bosch.com>
* Contributors: Musa Morena Marcusso Manhaes, Musa Morena Marcusso Manhães, Sebastian Scherer, sebastianscherer
