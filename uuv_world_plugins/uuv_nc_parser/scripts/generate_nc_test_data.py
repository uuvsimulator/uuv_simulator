...
if __name__ == '__main__':
    ...
    nc_var.setncatts(dict(long_name='Time',
                          standard_name='time',
                          units='hours since 2017-1-1 00:00:0.0',
                          axis='t'))
    ...
    nc_var.setncatts(dict(long_name='X coordinates in the test volume',
                          var_desc='X coordinates',
                          standard_name='X',
                          units='m',
                          axis='X [m]'))
    # Assign the dimension data to the new NetCDF file.
    ...
    nc_var.setncatts(dict(long_name='Y coordinates in the test volume',
                          var_desc='Y coordinates',
                          standard_name='Y',
                          units='m',
                          axis='Y [m]'))
    # Assign the dimension data to the new NetCDF file.
    ...
    nc_var.setncatts(dict(long_name='Z coordinates in the test volume',
                          var_desc='Z coordinates',
                          standard_name='Z',
                          units='m',
                          axis='Z [m]'))
    # Assign the dimension data to the new NetCDF file.
    ...
    nc_var.setncatts(dict(long_name='Temperature in the test volume',
    ...
    nc_var.setncatts(dict(long_name='Water salinity in the test volume',
                          var_desc='Salinity',
    ...
    nc_var.setncatts(dict(long_name='Water turbidity in the test volume',
                          var_desc='Turbidity',
    ...
    nc_var.setncatts(dict(long_name='Northward wind',
                          var_desc='Northward wind',
                          standard_name='Northward wind',
                          units='m/s',
                          axis='Northward wind [m/s]'))
