...
* FIX Typos and package version
  Signed-off-by: Musa Morena Marcusso Manhaes <Musa.Marcusso@de.bosch.com>
* Merge pull request `#146 <https://github.com/uuvsimulator/uuv_simulator/issues/146>`_ from uuvsimulator/fix/seabed_tutorial
...
* Merge pull request `#43 <https://github.com/uuvsimulator/uuv_simulator/issues/43>`_ from uuvsimulator/dev/init_tutorials
  Dev/init tutorials
