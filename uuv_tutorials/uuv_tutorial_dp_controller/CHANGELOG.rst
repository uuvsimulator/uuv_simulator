...
* FIX Typos and package version
  Signed-off-by: Musa Morena Marcusso Manhaes <Musa.Marcusso@de.bosch.com>
* Merge pull request `#150 <https://github.com/uuvsimulator/uuv_simulator/issues/150>`_ from uuvsimulator/fix/dp_controller_tutorial_init
...
* Merge pull request `#50 <https://github.com/uuvsimulator/uuv_simulator/issues/50>`_ from uuvsimulator/dev/tutorial_dp_controller
  Dev/tutorial dp controller
* FIX Integrator.
  Signed-off-by: Musa Morena Marcusso Manhães <Musa.Marcusso@de.bosch.com>
...
* ADD Tutorial on how to use the DP controller base class to create a new controller for a thruster actuated vehicle.
  Signed-off-by: Musa Morena Marcusso Manhães <Musa.Marcusso@de.bosch.com>
* Contributors: Musa Morena Marcusso Manhaes, Musa Morena Marcusso Manhães, sebastianscherer
