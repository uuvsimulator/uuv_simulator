...
* FIX Exception handling and log output
  Signed-off-by: Musa Morena Marcusso Manhaes <Musa.Marcusso@de.bosch.com>
* Merge pull request `#237 <https://github.com/uuvsimulator/uuv_simulator/issues/237>`_ from uuvsimulator/fix/test_gm_current_angle
...
* CHANGE Version
* Merge pull request `#197 <https://github.com/uuvsimulator/uuv_simulator/issues/197>`_ from uuvsimulator/fix/init_waypoint_timeout
...
* FIX Catkin requirements for catkin_make and catkin build
  Signed-off-by: Musa Morena Marcusso Manhaes <Musa.Marcusso@de.bosch.com>
* Merge pull request `#188 <https://github.com/uuvsimulator/uuv_simulator/issues/188>`_ from uuvsimulator/feature/set_scalar_parameter
  ADD Script and launch file to set a scalar parameter using ROS service
* ADD Script and launch file to set a scalar parameter using ROS service
  Signed-off-by: Musa Morena Marcusso Manhaes <Musa.Marcusso@de.bosch.com>
* Merge pull request `#183 <https://github.com/uuvsimulator/uuv_simulator/issues/183>`_ from uuvsimulator/feature/node_gm_current_setting
...
* FIX Package dependencies for rosdep
  Signed-off-by: Musa Morena Marcusso Manhaes <Musa.Marcusso@de.bosch.com>
* Merge pull request `#63 <https://github.com/uuvsimulator/uuv_simulator/issues/63>`_ from uuvsimulator/fix/control_utils_install
  ADD send_waypoint_file.py to the install path.
* ADD send_waypoint_file.py to the install path.
  Signed-off-by: Musa Morena Marcusso Manhães <Musa.Marcusso@de.bosch.com>
* Merge pull request `#52 <https://github.com/uuvsimulator/uuv_simulator/issues/52>`_ from uuvsimulator/dev/tutorial_disturbances
  Dev/tutorial disturbances
...
* ADD Utility scripts to start disturbances, pre-defined trajectories and marker publishers.
  Signed-off-by: Musa Morena Marcusso Manhães <Musa.Marcusso@de.bosch.com>
* Contributors: Musa Morena Marcusso Manhaes, Musa Morena Marcusso Manhães, lurido, sebastianscherer
