...
* CHANGE Bump version to 0.5.2
  Signed-off-by: Musa Morena Marcusso Manhaes <Musa.Marcusso@de.bosch.com>
* Merge pull request `#226 <https://github.com/uuvsimulator/uuv_simulator/issues/226>`_ from g-arjones/fix/cascade_pid_dependencies
...
* Merge branch 'dev/preparation_mangalia' of github.com:uuvsimulator/uuv_simulator into dev/preparation_mangalia
...
* Contributors: Gabriel Arjones, Musa Morena Marcusso Manhaes, Musa Morena Marcusso Manhães, Sebastian Scherer, Sebastian Scherer (CR/AEI), lurido, sebastianscherer
