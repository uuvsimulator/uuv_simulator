...
(cl:defclass <Waypoint> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (heading_offset
    ...
    :initform 0.0)
   (use_fixed_heading
    :reader use_fixed_heading
    :initarg :use_fixed_heading
    :type cl:boolean
    :initform cl:nil)
   (radius_of_acceptance
    :reader radius_of_acceptance
    :initarg :radius_of_acceptance
    :type cl:float
    :initform 0.0))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_control_msgs-msg:<Waypoint> is deprecated: use uuv_control_msgs-msg:Waypoint instead.")))
...
(cl:defmethod point-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_control_msgs-msg:point-val is deprecated.  Use uuv_control_msgs-msg:point instead.")
  (point m))

(cl:ensure-generic-function 'max_forward_speed-val :lambda-list '(m))
(cl:defmethod max_forward_speed-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_control_msgs-msg:max_forward_speed-val is deprecated.  Use uuv_control_msgs-msg:max_forward_speed instead.")
  (max_forward_speed m))

(cl:ensure-generic-function 'heading_offset-val :lambda-list '(m))
(cl:defmethod heading_offset-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_control_msgs-msg:heading_offset-val is deprecated.  Use uuv_control_msgs-msg:heading_offset instead.")
  (heading_offset m))

(cl:ensure-generic-function 'use_fixed_heading-val :lambda-list '(m))
(cl:defmethod use_fixed_heading-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_control_msgs-msg:use_fixed_heading-val is deprecated.  Use uuv_control_msgs-msg:use_fixed_heading instead.")
  (use_fixed_heading m))

(cl:ensure-generic-function 'radius_of_acceptance-val :lambda-list '(m))
(cl:defmethod radius_of_acceptance-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_control_msgs-msg:radius_of_acceptance-val is deprecated.  Use uuv_control_msgs-msg:radius_of_acceptance instead.")
  (radius_of_acceptance m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Waypoint>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'heading_offset))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'use_fixed_heading) 1 0)) ostream)
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'radius_of_acceptance))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Waypoint>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'point) istream)
    ...
    (cl:setf (cl:slot-value msg 'use_fixed_heading) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'radius_of_acceptance) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Waypoint>)))
  ...
  "0efb7fda1b5980152de94b6064a5cf35")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Waypoint)))
  "Returns md5sum for a message object of type 'Waypoint"
  "0efb7fda1b5980152de94b6064a5cf35")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Waypoint>))
  ...
  (cl:list 'Waypoint
    ...
    (cl:cons ':use_fixed_heading (use_fixed_heading msg))
    (cl:cons ':radius_of_acceptance (radius_of_acceptance msg))
))
