...
class GetMBSMControllerParamsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetMBSMControllerParamsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetMBSMControllerParamsRequest
    let len;
    let data = new GetMBSMControllerParamsRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMBSMControllerParamsRequest(null);
    return resolved;
    }
};

class GetMBSMControllerParamsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.lambda = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetMBSMControllerParamsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetMBSMControllerParamsResponse
    let len;
    let data = new GetMBSMControllerParamsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMBSMControllerParamsResponse(null);
...
module.exports = {
  Request: GetMBSMControllerParamsRequest,
  Response: GetMBSMControllerParamsResponse,
  md5sum() { return '7293aecc8487ffe3e998814d65aa6940'; },
  datatype() { return 'uuv_control_msgs/GetMBSMControllerParams'; }
};
