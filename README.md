## uuv_simulator (kinetic) - 0.6.1-1

The packages in the `uuv_simulator` repository were released into the `kinetic` distro by running `/usr/local/bin/bloom-release --rosdistro kinetic --track kinetic uuv_simulator --edit` on `Thu, 29 Nov 2018 01:01:40 -0000`
